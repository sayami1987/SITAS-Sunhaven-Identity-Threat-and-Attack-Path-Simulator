...
# The requirements are based on the implemented Sunhaven threat-modelling prototype and are updated as the project develops. Detailed links between requirements, implementation files, tests and evidence will be maintained separately in `requirements-traceability.md`.
...
# A separate requirements traceability matrix will map each requirement to its implementation, test case and supporting evidence.
